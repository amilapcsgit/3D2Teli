...
def flatten_mesh(vertices, faces, path_output, path_png=None, vertice_init_id=0, show_plot=True, input_unit="mm", method="LSCM"):
    ...
    metrics = _compute_metrics(vertices * scale, faces, unwrap, bounds, 1.0)
    return {
        "bounds": len(bounds),
        "metrics": metrics,
        "method": method,
